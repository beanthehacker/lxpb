...
`find_range` was written there the same day and vendored from it.
Refresh them from there:

```powershell
Copy-Item E:\daily-analysis\patterns-pure\{find_LP,find_eqh_eql,find_inside_bar,find_engulfing_bullish,find_engulfing_bearish,find_targets,find_range}.py `
